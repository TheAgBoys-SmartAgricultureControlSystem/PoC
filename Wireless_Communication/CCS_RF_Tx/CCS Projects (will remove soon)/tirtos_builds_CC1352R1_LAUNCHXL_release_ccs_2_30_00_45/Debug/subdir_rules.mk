...
build-1318850271:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1318850271-inproc

build-1318850271-inproc: ../release.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-1318850271 ../release.cfg
configPkg/compiler.opt: build-1318850271
configPkg/: build-1318850271
